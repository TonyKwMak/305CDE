...
function calculate() {
    ...
    if (quantity>100){
        discount = discount*2;
        document.getElementById("show_double").style.display = 'block';
    } else{
        document.getElementById("show_double").style.display = 'none';
    }
    ...
    console.log("total after shipping: " + shipping);
